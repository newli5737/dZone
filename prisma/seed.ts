...
async function main() {
  ...
  const admin = await prisma.user.upsert({
    where: { email: 'admin@vzone.vn' },
    update: {},
    create: {
      email: 'admin@vzone.vn',
      name: 'Admin VZone',
    ...
    const samplePosts = [
      {
        ...
        thumbnail: '', published: true, featured: true, authorId: admin.id, categoryId: lamDep.id,
      },
      {
      ...
      },
      {
        ...
        thumbnail: '', published: true, featured: false, authorId: admin.id, categoryId: muaSam.id,
      },
      {
        ...
        thumbnail: '', published: true, featured: false, authorId: admin.id, categoryId: lamDep.id,
      },
      {
        ...
        thumbnail: '', published: true, featured: true, authorId: admin.id, categoryId: amThuc.id,
      },
      {
        ...
        thumbnail: '', published: true, featured: false, authorId: admin.id, categoryId: amThuc.id,
      },
    ];
